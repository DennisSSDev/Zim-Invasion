...
public class Manager : MonoBehaviour
{
    ...
    public int resolution = 128; // still not sure why we need resolution hence we can generate perlin noise through the width and height 
    ...
    void Start()
    {
        ...
        data.heightmapResolution = resolution;//set the resolution
